...
#  options  passed through to run_ivector_common.sh
# some  are also used in this script directly.
stage=0
decode_nj=10
train_set=train
test_sets="dev devtest test"
gmm=tri3b
nnet3_affix=

#  configs specific to this script.
# Most of the parameters are hardcoded at this level, in the commands below.
...
local/nnet3/run_ivector_common.sh \
    --stage $stage --train-set $train_set --gmm $gmm --nnet3-affix "$nnet3_affix"
...
if [ $stage -le 11 ]; then
	...
	--nj 20 --cmd "$train_cmd" ${lores_train_data_dir} data/lang $gmm_dir \
	$lat_dir
